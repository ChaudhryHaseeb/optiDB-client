...
public class Resultat {
    ...
    public Resultat(String platformName, int nbCol, int nbLine, long tempsCreate, ArrayList listeInsert,
                    long tempsUpdate, long tempsSelect, long tempsSelectAll,
                    long tempsAlter, long tempsDelete, long tempsDrop)
    {
